        ...
        <div className="w-11/12 mx-auto ">
         ...
         <div className="home_container md:flex mt-9 gap-4">
            ...
            <div className="card-container grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 w-9/12 gap-4">
               {
                data.map((data) => (
                    <div key={data.id} className="card  bg-base-100 shadow-xl space-y-4">
                    <figure className="mt-4"><img src={data.image} alt="Shoes" /></figure>
                    <div className="card-body">
                      <h2 className="text-lg font-bold">{data.course_name}</h2>
                      <p className="text-sm font-normal">{data.detiels}.....</p>
